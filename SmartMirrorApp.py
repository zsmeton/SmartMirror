...
class WeatherDisplay(BoxLayout):
    ...
    hour_2_icon = ObjectProperty(None)
    hour_4_icon = ObjectProperty(None)
    hour_6_icon = ObjectProperty(None)
    hour_8_icon = ObjectProperty(None)
    hour_10_icon = ObjectProperty(None)
    hour_12_icon = ObjectProperty(None)

    def __init__(self, **kwargs):
        super().__init__()
        self.__dict__.update(kwargs)
        self.hours = [self.hour_2_icon, self.hour_4_icon, self.hour_6_icon, self.hour_8_icon, self.hour_10_icon,
                      self.hour_12_icon]
    ...
    def update(self, dt=None):
        ...
        for i, hour in enumerate(self.hours):
            hour.update(shape=self.weather['hourly'][i]['shape'], fill=self.weather['hourly'][i]['fill%'])
...
class MainScreen(Screen):
    ...
    loading_icon = ObjectProperty(None)
